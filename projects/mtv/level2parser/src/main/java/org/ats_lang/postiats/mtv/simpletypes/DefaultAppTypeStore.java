...
public class DefaultAppTypeStore {
    ...
    static public String con_list0_t0ype_type = "list0_t0ype_type";  // sort of list0_t0ype_type is ((t: t0ype) -> type)
    
    static public String con_g0int_t0ype = "g0int_t0ype";  // sort of g0int_t0ype is ((atstype_int: tkind) -> t0ype)
